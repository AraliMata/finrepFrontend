...
//Add values to header
    ...
    grid.rows.add();
    grid.rows[0].cells[0].value = "Ingreso";
                        //data.ingreso.length
    for (int i = 0; i < data.ingreso.length; i++) {
      PdfGridRow curRow = grid.rows.add();
                                //data.ingreso[i][0] data.ingreso[i][1] data.ingreso[i][2]
      curRow.cells[0].value = data.ingreso[i][0];
      curRow.cells[0].value = data.ingreso[i][1];
      curRow.cells[0].value = data.ingreso[i][2];
      curRow.cells[0].value = data.ingreso[i][3];
      curRow.cells[0].value = data.ingreso[i][4];
    }

    grid.rows.add();
    grid.rows[0].cells[0].value = "Egreso";
    for (int i = 0; i < data.egreso.length; i++) {
          PdfGridRow curRow = grid.rows.add();
                                    //data.ingreso[i][0] data.ingreso[i][1] data.ingreso[i][2]
          curRow.cells[0].value = data.egreso[i][0];
          curRow.cells[0].value = data.egreso[i][1];
          curRow.cells[0].value = data.egreso[i][2];
          curRow.cells[0].value = data.egreso[i][3];
          curRow.cells[0].value = data.egreso[i][4];
